...
[InlineKeyboardButton("صاحب السورس 🧑‍✈️", url=f"https://t.me/V_K_Z")],
[InlineKeyboardButton("طريقة التشغيل 🧠", callback_data="bcmds"),InlineKeyboardButton("طريقة التفعيل 🦸", callback_data="bhowtouse")],
[InlineKeyboardButton("جروب البوت 🤖", url=f"https://t.me/qkpqp"),InlineKeyboardButton("قناه التحديثات 🐉", url=f"https://t.me/zxxlz")],
